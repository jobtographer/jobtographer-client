...
export const getJobDetailJobDescriptionText = state => getJobDetail(state).jobDescriptionText;
...
export const getJobDetailResume = state => getJobDetail(state).resume;
export const getJobDetailCoverLetter = state => getJobDetail(state).coverLetter;
